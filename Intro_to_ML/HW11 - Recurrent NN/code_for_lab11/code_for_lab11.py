...
if __name__ == "__main__":
    ...
    #test_word("abcabcabcabcabc", num_hidden=5, num_steps=10000)
    #test_class_names(interactive = True, interactive_top5 = False, split=0, num_hidden = 150, num_steps = 20000, step_size = .001, train=True)
    #test_class_names()
    #test_metal()
    #test_food()
    #pass
